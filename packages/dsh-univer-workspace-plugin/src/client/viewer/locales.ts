...
const zhCN = [
  UniverDesignZhCN, UniverSheetsZhCN, UniverSheetsUIZhCN,
  ...
  UniverBoardsPrintZhCN, UniverDocsCalloutUIZhCN, UniverDocsChartUIZhCN,
  UniverDocsColumnUIZhCN, UniverDocsExchangeZhCN, UniverDocsCodeUIZhCN,
  UniverDocsListUIZhCN, UniverDocsQuoteUIZhCN, UniverDocsShapeUIZhCN,
  UniverDocsTableUIZhCN, UniverDocsLatexUIZhCN, UniverDocsPrintZhCN,
  UniverSheetsChartZhCN, UniverSheetsChartUIZhCN,
  UniverSheetsConditionalFormattingZhCN, UniverSheetsConditionalFormattingUIZhCN,
  UniverSheetsCrosshairZhCN, UniverSheetsDataValidationZhCN,
  UniverSheetsDataValidationUIZhCN, UniverSheetsDrawingUIZhCN,
  UniverSheetsFilterZhCN, UniverSheetsFilterUIZhCN, UniverSheetsHyperLinkZhCN,
  UniverSheetsHyperLinkUIZhCN, UniverSheetsNoteUIZhCN, UniverSheetsNumfmtUIZhCN,
  UniverSheetsOutlineUIZhCN, UniverSheetsPivotZhCN, UniverSheetsPivotUIZhCN,
  UniverSheetsExchangeZhCN, UniverSheetsPrintZhCN, UniverSheetsShapeUIZhCN,
  UniverSheetsSortUIZhCN, UniverSheetsSparklineUIZhCN, UniverSheetsTableZhCN,
  UniverSheetsTableUIZhCN, UniverSheetsThreadCommentUIZhCN,
  UniverThreadCommentUIZhCN, UniverSlidesZhCN, UniverSlidesUIZhCN,
  UniverSlidesChartUIZhCN, UniverSlidesTableUIZhCN, UniverSlidesExchangeZhCN,
  UniverSlidesPrintZhCN, ChartUIZhCN, EngineChartZhCN,
  CollaborationClientZhCN, CollaborationClientUIZhCN,
  PresetDocsCoreZhCN, PresetDocsDrawingZhCN, PresetDocsHyperLinkZhCN,
  PresetDocsThreadCommentZhCN, PresetSheetsAdvancedZhCN,
  PresetSheetsConditionalFormattingZhCN, PresetSheetsCoreZhCN,
  PresetSheetsDataValidationZhCN, PresetSheetsDrawingZhCN, PresetSheetsFilterZhCN,
  PresetSheetsFindReplaceZhCN, PresetSheetsHyperLinkZhCN, PresetSheetsNoteZhCN,
  PresetSheetsSortZhCN, PresetSheetsTableZhCN, PresetSheetsThreadCommentZhCN,
  PresetSheetsCollaborationZhCN,
] as const;

const enUS = [
  UniverDesignEnUS, UniverSheetsEnUS, UniverSheetsUIEnUS,
  ...
  UniverBoardsPrintEnUS, UniverDocsCalloutUIEnUS, UniverDocsChartUIEnUS,
  UniverDocsColumnUIEnUS, UniverDocsExchangeEnUS, UniverDocsCodeUIEnUS,
  UniverDocsListUIEnUS, UniverDocsQuoteUIEnUS, UniverDocsShapeUIEnUS,
  UniverDocsTableUIEnUS, UniverDocsLatexUIEnUS, UniverDocsPrintEnUS,
  UniverSheetsChartEnUS, UniverSheetsChartUIEnUS,
  UniverSheetsConditionalFormattingEnUS, UniverSheetsConditionalFormattingUIEnUS,
  UniverSheetsCrosshairEnUS, UniverSheetsDataValidationEnUS,
  UniverSheetsDataValidationUIEnUS, UniverSheetsDrawingUIEnUS,
  UniverSheetsFilterEnUS, UniverSheetsFilterUIEnUS, UniverSheetsHyperLinkEnUS,
  UniverSheetsHyperLinkUIEnUS, UniverSheetsNoteUIEnUS, UniverSheetsNumfmtUIEnUS,
  UniverSheetsOutlineUIEnUS, UniverSheetsPivotEnUS, UniverSheetsPivotUIEnUS,
  UniverSheetsExchangeEnUS, UniverSheetsPrintEnUS, UniverSheetsShapeUIEnUS,
  UniverSheetsSortUIEnUS, UniverSheetsSparklineUIEnUS, UniverSheetsTableEnUS,
  UniverSheetsTableUIEnUS, UniverSheetsThreadCommentUIEnUS,
  UniverThreadCommentUIEnUS, UniverSlidesEnUS, UniverSlidesUIEnUS,
  UniverSlidesChartUIEnUS, UniverSlidesTableUIEnUS, UniverSlidesExchangeEnUS,
  UniverSlidesPrintEnUS, ChartUIEnUS, EngineChartEnUS,
  CollaborationClientEnUS, CollaborationClientUIEnUS,
  PresetDocsCoreEnUS, PresetDocsDrawingEnUS, PresetDocsHyperLinkEnUS,
  PresetDocsThreadCommentEnUS, PresetSheetsAdvancedEnUS,
  PresetSheetsConditionalFormattingEnUS, PresetSheetsCoreEnUS,
  PresetSheetsDataValidationEnUS, PresetSheetsDrawingEnUS, PresetSheetsFilterEnUS,
  PresetSheetsFindReplaceEnUS, PresetSheetsHyperLinkEnUS, PresetSheetsNoteEnUS,
  PresetSheetsSortEnUS, PresetSheetsTableEnUS, PresetSheetsThreadCommentEnUS,
