  ...
  return registerUniverTool(ctx, defineTool({
    ...
    parameters: {
      ...
      queries: {
        ...
        required: true,
        items: { type: "string" },
        description: "One or more non-empty API terms, such as conditionalFormat, FRange, or FRange.setValue.",
      },
    ...
    async execute(args) {
      ...
      return { ok: true as const, operation: "api" as const, result: result as unknown as JsonValue };
    },
    presentCall: (args) => ({
      card: "generic",
