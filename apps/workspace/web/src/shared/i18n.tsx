...
const messages = {
  "zh-CN": {
    ...
    nativePreviewTitle: "Office 预览",
    nativePreviewReadOnly: "实时 · 只读",
    nativePreviewEditable: "实时协作",
    nativePreviewDownload: "下载 PPTX",
    nativePreviewDownloading: "正在导出…",
    nativePreviewDownloadError: "导出失败，请重试",
    nativePreviewOpen: "打开文件",
    nativePreviewMissing: "定位内容已改变",
    nativePreviewError: "无法打开预览。请确认你有权限访问该文件，然后重新打开。",
    nativePreviewLoading: "正在打开文件…",
    nativePreviewShare: "分享此 HTML 文件",
    nativePreviewShareDescription: "复制链接给已有访问权限的同事。嵌入的 Office 文件和来源表格仍分别校验权限。",
    ...
    publicRead: "公开只读",
    publicReadDescription: "开启后，获得链接的任何人无需登录即可浏览并只读打开此空间下的文件。",
    create: "创建",
    new: "新建",
    newDocument: "新建文档",
    uploadFile: "上传文件",
    ...
    editingMode: "可编辑",
    readOnlyMode: "只读",
    trialNoticeTitle: "试用环境",
    trialNoticeBody: "当前为试用环境，不保证数据持久保存，请勿存放重要数据。",
    trialNoticeSelfHost: "如需长期使用，请参考开源仓库自行部署：",
    trialNoticeAcknowledge: "我知道了",
  ...
  "en-US": {
    ...
    nativePreviewTitle: "Office preview",
    nativePreviewReadOnly: "Live · Read only",
    nativePreviewEditable: "Live collaboration",
    nativePreviewDownload: "Download PPTX",
    nativePreviewDownloading: "Exporting…",
    nativePreviewDownloadError: "Export failed. Please retry.",
    nativePreviewOpen: "Open file",
    nativePreviewMissing: "Location has changed",
    nativePreviewError: "Preview unavailable. Check your access to this file, then open it again.",
    nativePreviewLoading: "Opening file…",
    nativePreviewShare: "Share this HTML file",
    ...
    publicReadDescription:
      "Anyone with the link can browse and open files in this space read-only without signing in.",
    create: "Create",
    new: "New",
    ...
    trialNoticeTitle: "Trial environment",
    trialNoticeBody:
      "This is a trial environment. Data may not be preserved, so do not store anything important.",
    trialNoticeSelfHost: "For long-term use, deploy your own instance from the open-source repository:",
    trialNoticeAcknowledge: "Got it",
    ...
    enterImmersiveView: "Enter immersive view",
    ...
    linkSharingDescription:
      "Anyone with the link can view without signing in. Signed-in users get the selected access.",
    linkSharingEnabled: "Link access is on",
    linkSharingDisabled: "Link access is off",
    linkSharingEnabledDescription:
      "Anyone with the link can view it; it will not appear in Shared with me.",
    linkSharingDisabledDescription:
      "Access follows collaborator permissions or the Space public-read setting.",
    linkSharingOn: "On",
    linkSharingOff: "Off",
    linkSharingPrivacyNote:
      "Visitors are always read-only. Editing requires sign-in and edit permission.",
