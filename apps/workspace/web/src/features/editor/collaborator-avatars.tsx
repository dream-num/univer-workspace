        ...
        {users.slice(0, VISIBLE_MEMBERS).map((member) => (
          <Tooltip key={member.userID} content={memberLabel(member)}>
            <span
              ...
              className="relative inline-flex rounded-full ring-2 ring-background outline-offset-4 hover:z-10 focus-visible:z-10 focus-visible:outline-2 focus-visible:outline-ring"
            >
              <Avatar
                src={member.avatar}
                name={member.name}
