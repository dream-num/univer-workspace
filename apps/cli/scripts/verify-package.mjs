...
for (const path of [
  ...
  "skill-data/html-view/SKILL.md",
  "skill-data/html-view/references/authoring.md",
  "skill-data/html-view/references/adding-records.md",
  "skill-data/html-view/references/charts.md",
  "skill-data/html-view/references/frontend-libraries.md",
