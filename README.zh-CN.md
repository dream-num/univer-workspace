...
[Univer 文档](https://docs.univer.ai/) · [Office SDK 文档](https://office.univer.ai/) · [CLI 指南](apps/cli/README.md) · [Workspace Agent](apps/agent/README.md) · [Issues](https://github.com/dream-num/univer-workspace/issues)
...
apps/agent                   连接一个可配置 Workspace 的本地 DSH Web 客户端
...
| [Workspace Agent 指南](apps/agent/README.md)                         | 本地 profile、设备授权、会话、文件、Worktree 与身份切换    |
